...
async function analyze(targetImage, dockerfileAnalysis, imageType, imagePath, globsToFind, appScan) {
    ...
    const { imageId, manifestLayers, extractedLayers, rootFsLayers, autoDetectedUserInstructions, platform, } = await archiveExtractor.extractImageContent(imageType, imagePath, staticAnalysisActions);
